...
void dual_solve_test_simple() {
  FPN A[] = {0.1093, 0.5517, 0.0000, 0.0000, 0.5462, 0.2204, 0.0000, 0.0000,
             0.2279, 0.2967, 1.0000, 0.0000, 0.4767, 0.3233, 0.0000, 1.0000};

  FPN b[] = {0.2459, 0.1865, 0.4121, 1.1073};
  FPN c[] = {0.9559, 0.1349, 0.0000, 0.0000};
